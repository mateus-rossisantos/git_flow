...
public interface UsuarioApi {
    ...
    @PostMapping
    ResponseEntity<User> postUsuario(@RequestBody UserDTO usuariosDTO);
    ...
    @GetMapping("/{id}")
    ResponseEntity<UserReturnDTO> getUsuario(@PathVariable String id);
    ...
    @GetMapping
    Page<UserReturnDTO> getUsuarios(Pageable pageable);
