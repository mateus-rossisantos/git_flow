...
class AnimalControllerTest {
    ...
    void setup() {
        ...
        Mockito.when(animalServiceMock
                        .replaceAnimal(ArgumentMatchers.any(AnimalDTO.class), ArgumentMatchers.anyString()))
    ...
    void list_ReturnsListOfAnimalsInsidePageObject_WhenSuccessful(){
        ...
        Page<Animal> animaisPage = animalController.getAnimals(null);
    ...
    void save_Returns201anAnimal_WhenSuccessful(){
        AnimalDTO animalTobeSaved = modelMapper.map(AnimalCreator.createAnimalValid(), AnimalDTO.class);
    ...
    void put_ReplaceAnimalReturn200_WhenSuccessful(){
        AnimalDTO animaisDTO = modelMapper.map(AnimalCreator.createUpdatedAnimal(), AnimalDTO.class);
    ...
    void put_ReplaceAnimal_Returns404_WhenNotSuccessful(){
        Mockito.when(animalServiceMock
                ...
                .thenReturn(ResponseEntity.notFound().build());
        String id = "3454578";
        AnimalDTO animalDto = new AnimalDTO("Teste", "Tester");
